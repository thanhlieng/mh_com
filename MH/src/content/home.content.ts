...
export const homeContent: HomeContent = {
  ...
  partners: {
    ...
    carriers: {
      ...
      items: [
        { name: 'Maersk', note: { vi: 'Á – Âu, Á – Mỹ', en: 'Asia–Europe, Asia–Americas' } },
        { name: 'MSC', note: { vi: 'Mạng lưới toàn cầu', en: 'Global network' } },
        { name: 'CMA CGM', note: { vi: 'Á – Âu, nội Á', en: 'Asia–Europe, intra-Asia' } },
        { name: 'COSCO', note: { vi: 'Nội Á, xuyên Thái Bình Dương', en: 'Intra-Asia, transpacific' } },
        { name: 'Evergreen', note: { vi: 'Nội Á, Á – Mỹ', en: 'Intra-Asia, Asia–US' } },
        { name: 'ONE', note: { vi: 'Á – Âu, Á – Mỹ', en: 'Asia–Europe, Asia–US' } },
        { name: 'HMM', note: { vi: 'Nội Á, Á – Âu', en: 'Intra-Asia, Asia–Europe' } },
        { name: 'SITC', note: { vi: 'Chuyên tuyến nội Á', en: 'Intra-Asia specialist' } },
      ],
    },
    domestic: {
